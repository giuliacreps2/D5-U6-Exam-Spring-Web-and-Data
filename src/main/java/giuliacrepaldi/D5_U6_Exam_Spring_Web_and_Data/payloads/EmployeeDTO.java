...
public record EmployeeDTO(
        @NotBlank(message = "L'username deve essere valido")
        ...
        String name,
        @NotBlank(message = "Il cognome deve essere valido")
        @Size(min = 1, max = 50, message = "Il cognome deve contenere un minimo di 2 e una massimo di 30 caratteri")
        String surname,
